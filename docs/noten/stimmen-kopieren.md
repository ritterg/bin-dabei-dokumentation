...
Die Funktion findest du auf der **Notenverwaltungs-Startseite** («Noten» → «Verwaltung») rechts im Bereich **«Werkzeuge»**:
...
![«Werkzeuge»-Bereich mit «Stimmenzuteilung kopieren», den zwei Namens-Listen, der Kategorie-Auswahl, der Wahl «Ergänzen / Ersetzen» und der Taste «Kopieren»](../img/noten-kopieren.png)
