...
3. Wähle, ob die bestehende Zuteilung des Zielmitglieds **ergänzt** oder **ersetzt** werden soll (siehe unten).
4. Klicke auf **«Kopieren»**.

![«Werkzeuge»-Bereich mit «Stimmenzuteilung kopieren», den zwei Namens-Listen, der Wahl «Ergänzen / Ersetzen» und der Taste «Kopieren»](../img/noten-kopieren.png)
...
!!! info "Ergänzen oder Ersetzen?"
    ...
    - **Ersetzen**: Die bisherigen Zuteilungen des Zielmitglieds werden **zuerst gelöscht**, danach werden die des Quell-Mitglieds gesetzt. bin-dabei fragt vor dem Ersetzen zur Sicherheit nach.
